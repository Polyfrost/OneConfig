...
public class Colors {
    ...
    public static final int PRIMARY_800 = new Color(17, 33, 125).getRGB();          // Blue 800
    public static final int PRIMARY_700 = new Color(21, 51, 219).getRGB();          // Blue 700
    public static final int PRIMARY_700_80 = new Color(21, 51, 219, 204).getRGB();       // Blue 700 80%
    public static final int PRIMARY_600 = new Color(43, 75, 255).getRGB();          // Blue 600         // button blue normal
    public static final int PRIMARY_500 = new Color(64, 92, 246).getRGB();         // Blue 500         // button blue hover
    public static final int PRIMARY_400 = new Color(102, 124, 246).getRGB();
