...
public class ConfigInfo extends BasicOption {
    ...
    public void draw(long vg, int x, int y, InputHandler inputHandler) {
        Scissor scissor = LwjglManager.INSTANCE.getScissorHelper().scissor(vg, x, y, size == 1 ? 448 : 960, 32);
        LwjglManager.INSTANCE.getNanoVGHelper().drawInfo(vg, type, x, y + 4, 24);
        LwjglManager.INSTANCE.getNanoVGHelper().drawText(vg, name, x + 32, y + 18, Colors.WHITE_90, 14, Fonts.MEDIUM);
