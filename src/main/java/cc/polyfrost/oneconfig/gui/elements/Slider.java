...
public class Slider extends BasicElement {
    ...
    public void draw(long vg, float x, float y, InputHandler inputHandler) {
        ...
        if(mode == HORIZONTAL) {
            ...
            RenderManager.drawRoundedRect(vg, x + 2, y, width - 4, height, Colors.GRAY_300, 3f);
            RenderManager.drawRoundedRect(vg, x + 2, y + height - height * value, width - 4, height * value, Colors.PRIMARY_500, 3f);
            RenderManager.drawRoundedRect(vg, x - 8, currentDragPoint - dragPointerSize / 2, 24, 24, Colors.WHITE, 12f);
        }
