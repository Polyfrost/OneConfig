...
public class TextOptionType implements OptionType {
    ...
    public String getName(Method method) {
        return method.getAnnotation(Text.class).name();
    }

    @Override
    public String getDescription(Field field) {
        return field.getAnnotation(Text.class).description();
    }

    @Override
    public String getDescription(Method method) {
        return method.getAnnotation(Text.class).description();
    }

    @Override
    public String getCategory(Field field) {
        return field.getAnnotation(Text.class).category();
    }

    @Override
    public String getCategory(Method method) {
        return method.getAnnotation(Text.class).category();
    }

    @Override
    public String getSubcategory(Field field) {
        return field.getAnnotation(Text.class).subcategory();
    }

    @Override
    public String getSubcategory(Method method) {
        return method.getAnnotation(Text.class).subcategory();
    }

    @Override
    public String[] getTags(Field field) {
        return field.getAnnotation(Text.class).tags();
    }

    @Override
    public String[] getTags(Method method) {
        return method.getAnnotation(Text.class).tags();
    }
}
