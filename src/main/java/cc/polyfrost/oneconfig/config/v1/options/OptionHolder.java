...
/**
 * Represents an option from an {@link cc.polyfrost.oneconfig.config.v1.OneConfig}.
 */
public interface OptionHolder {
    ...
    /**
     * Either returns the value of the option, or invokes the method if the options is a {@link cc.polyfrost.oneconfig.config.v1.options.type.annotations.Button}.
     * @return The value of the option, or {@link NoReturnValue} if the option is a {@link cc.polyfrost.oneconfig.config.v1.options.type.annotations.Button}.
     */
    Object invoke();
