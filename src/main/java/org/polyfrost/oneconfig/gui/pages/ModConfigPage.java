...
package org.polyfrost.oneconfig.gui.pages;

import org.polyfrost.oneconfig.config.elements.BasicOption;
import org.polyfrost.oneconfig.config.elements.OptionCategory;
...
import org.polyfrost.oneconfig.utils.SearchUtils;
...
public class ModConfigPage extends Page {
    ...
    public ModConfigPage(OptionPage page, boolean base) {
        ...
        for (String category : page.categories.keySet()) {
            BasicButton button = new BasicButton(0, BasicButton.SIZE_32, category, BasicButton.ALIGNMENT_CENTER, ColorPalette.SECONDARY);
