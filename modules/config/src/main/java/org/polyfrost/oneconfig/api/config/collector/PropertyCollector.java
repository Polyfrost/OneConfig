...
public interface PropertyCollector {
     ...
     *
     * @param id  the ID to use for this tree
     ...
     */
    @Nullable Tree collect(@Nullable String id, @NotNull Object src);

    default Tree collect(@NotNull Object src) {
        return collect(null, src);
    }
