...
interface MinecraftKeybindBridge {
    /** Register or refresh the vanilla mapping mirroring [bind]. Called when a keybind is registered with the manager. */
    ...
    /**
     * Push [bind]'s current keys/modifiers onto its vanilla mapping. Called when OneConfig changes a keybind (e.g. a
     * rebind in the OneConfig settings UI) so the Controls menu reflects the new value.
     */
