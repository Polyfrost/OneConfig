...
object SkiaCtx {
    ...
    // ── Direct back-buffer surface for Compose screen draws ─────────────
    private var glSurface: Surface? = null
    private var glBrt: BackendRenderTarget? = null

    // ── Vulkan surface cache (shared by Compose + HUD on VK) ────────────
    ...
    // ── HUD: offscreen TextureTarget approach ───────────────────────────

    /** Flush queued HUD draws into the offscreen [hudTarget]. Does NOT blit. */
    fun drawNow() {
