...
import org.polyfrost.oneconfig.config.annotations.*;
import org.polyfrost.oneconfig.config.annotations.Number;
...
import org.polyfrost.oneconfig.config.migration.VigilanceMigrator;
import org.polyfrost.oneconfig.gui.GuiNotifications;
import org.polyfrost.oneconfig.gui.animations.Animation;
import org.polyfrost.oneconfig.gui.animations.EaseInOutQuart;
import org.polyfrost.oneconfig.gui.pages.HomePage;
...
import org.polyfrost.oneconfig.renderer.asset.Icon;
import org.polyfrost.oneconfig.test.huds.TestBasicHud_Test;
import org.polyfrost.oneconfig.test.huds.TestHud_Test;
import org.polyfrost.oneconfig.test.huds.TestMultilineHud_Test;
import org.polyfrost.oneconfig.test.inherit.ToggleableAndBoldElement_Test;
...
import org.polyfrost.oneconfig.config.data.OptionSize;
...
public class TestConfig_Test extends Config {
    ...
    @org.polyfrost.oneconfig.config.annotations.Page(
            name = "An actual page",
            description = "yes very cool",
            location = PageLocation.BOTTOM
    )
    private final Page page = new HomePage();
