...
public class PlatformCommandManagerImpl extends PlatformCommandManager {
    ...
    void createCommand(CommandManager.OCCommand root) {
        ...
        LiteralArgumentBuilder<ServerCommandSource> builder = net.minecraft.server.command.CommandManager.literal(root.getMetadata().value());
    ...
    Collection<String> getPlayerNames() {
        if (MinecraftClient.getInstance() != null && MinecraftClient.getInstance().getServer() != null) {
            return Arrays.asList(MinecraftClient.getInstance().getServer().getPlayerNames());
        } else return null;
    }
